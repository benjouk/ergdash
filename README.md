...
- **Ranking percentiles:** Set sex (plus optional birth year and body weight) in Settings and each personal best shows an estimated standing in the ranked erg population for your age band and weight class (e.g. `~top 18% - M 30-39 Hwt`), computed locally from a bundled approximation of the public Concept2 season ranking distributions
